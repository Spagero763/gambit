...
const STEPS = [
  {
    ...
    body: "Five classic games — chess, Naija Whot, tic-tac-toe, snakes & ladders, and a block puzzle. Play free against the engine, or stake cUSD on a 1v1 and the winner takes the pot.",
  },
  {
    icon: Wallet,
  ...
  },
  {
    ...
    body: "Tap any game to start instantly vs the engine. Choose “Staked 1v1” to put cUSD on the line — sign in once, set your stake, and play.",
  },
  {
    icon: Swords,
