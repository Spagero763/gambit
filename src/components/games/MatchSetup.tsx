          ...
          >
            <div className="rounded-3xl glass p-5 shadow-card">
              <p className="text-sm leading-relaxed text-ink-dim">
                ...
                want to put real money on the line.
              </p>
            </div>
              ...
              <div className="mt-4 rounded-2xl border border-line bg-void-700 p-4 text-center shadow-card">
                {opponentJoined ? (
                  ...
                  <>
                    ...
                    <ShareButton
                      text={`I just staked ${stake} ${token.symbol} on ${game.name}. Think you can beat me? Tap my link and join.`}
                      url={`${typeof window !== "undefined" ? window.location.origin : "https://www.bestgambit.live"}/play/${game.slug}?room=${matchId.toString()}&stake=${stake}&token=${token.address}`}
